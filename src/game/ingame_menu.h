...
enum DialogSpecialChars {
    ...
    DIALOG_CHAR_LOWER_A_ACUTE        = 0x63, // 'a' aigue
    ...
    DIALOG_CHAR_LOWER_U_ACUTE        = 0x83, // 'u' AIGUE
    ...
    DIALOG_CHAR_UPPER_U_ACUTE        = 0x87, // 'U' aigue
    ...
    DIALOG_CHAR_LOWER_O_ACUTE        = 0x93, // 'o' aigue
    ...
    DIALOG_CHAR_UPPER_O_ACUTE        = 0x97, // 'O' aigue
